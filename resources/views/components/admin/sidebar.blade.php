<div class="app-sidebar sidebar-shadow">
    ...
    <div class="app-header__menu">
        ...
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu metismenu">
                ...
                <li>
                    <a href="widgets-chart-boxes.html" aria-expanded="false">
                        <i class="metismenu-icon pe-7s-graph">
                        </i>Chart Boxes 1
                    </a>
                </li>
                <li>
                    <a href="widgets-chart-boxes-2.html" aria-expanded="false">
                        <i class="metismenu-icon pe-7s-way">
                        </i>Chart Boxes 2
                    </a>
                </li>
                <li>
                    <a href="widgets-chart-boxes-3.html" aria-expanded="false">
                        <i class="metismenu-icon pe-7s-ball">
                        </i>Chart Boxes 3
                    </a>
                </li>
                <li>
                    <a href="widgets-profile-boxes.html" aria-expanded="false">
                ...
                <li>
                    <a href="charts-chartjs.html" aria-expanded="false">
                        <i class="metismenu-icon pe-7s-graph2">
                        </i>ChartJS
                    </a>
                </li>
                <li>
                    <a href="charts-apexcharts.html" aria-expanded="false">
                        <i class="metismenu-icon pe-7s-graph">
                        </i>Apex Charts
                    </a>
                </li>
                <li>
                    <a href="charts-sparklines.html" aria-expanded="false">
    ...
    <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 850px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 765px;"></div></div></div>
</div>